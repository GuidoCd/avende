            ...
            <form @submit.prevent="handleSubmit" class="space-y-4">
              ...
              <div v-if="activeTab === 'register'" class="space-y-1">
                ...
                <div class="relative">
                  ...
                  <input type="text" placeholder="Ana Garcia" class="w-full pl-10 pr-4 py-3 bg-transparent border border-gray-200 dark:border-zinc-700 rounded-xl focus:ring-2 focus:ring-[#008f39] focus:border-[#008f39] outline-none transition-shadow text-gray-900 dark:text-white" required>
                </div>
              </div>
              ...
              <div class="space-y-1">
                ...
                <div class="relative">
                  ...
                  <input type="email" placeholder="tu@email.com" class="w-full pl-10 pr-4 py-3 bg-transparent border border-gray-200 dark:border-zinc-700 rounded-xl focus:ring-2 focus:ring-[#008f39] focus:border-[#008f39] outline-none transition-shadow text-gray-900 dark:text-white" required>
                </div>
              </div>
              ...
              <div class="space-y-1">
                ...
                <div class="relative">
                  ...
                  <input :type="showPassword ? 'text' : 'password'" placeholder="Min. 8 caracteres" class="w-full pl-10 pr-10 py-3 bg-transparent border border-gray-200 dark:border-zinc-700 rounded-xl focus:ring-2 focus:ring-[#008f39] focus:border-[#008f39] outline-none transition-shadow text-gray-900 dark:text-white" required>
              ...
              <div v-if="activeTab === 'register'" class="space-y-1">
                <label class="text-xs font-bold text-gray-500 uppercase tracking-wider">Confirmar Contraseña</label>
                <div class="relative">
                  <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
                  </div>
                  <input :type="showConfirmPassword ? 'text' : 'password'" placeholder="Repite tu contraseña" class="w-full pl-10 pr-10 py-3 bg-transparent border border-gray-200 dark:border-zinc-700 rounded-xl focus:ring-2 focus:ring-[#008f39] focus:border-[#008f39] outline-none transition-shadow text-gray-900 dark:text-white" required>
              ...
              <div class="pt-4">
                <button type="submit" class="w-full bg-[#008f39] hover:bg-emerald-700 text-white font-bold py-3.5 px-4 rounded-xl shadow-lg transition-colors flex justify-center items-center gap-2">
                  <span>{{ activeTab === 'register' ? 'Crear cuenta' : 'Ingresar' }}</span>
